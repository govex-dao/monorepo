 ...
 */
export function toScaledBigInt(value: number, scale: bigint = DECIMAL_SCALE): bigint {
 ...
 */
export function fromScaledBigInt(value: bigint, scale: bigint = DECIMAL_SCALE): number {
