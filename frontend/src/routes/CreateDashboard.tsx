...
export function CreateDashboard() {
  ...
  return (
    <Tabs.Root defaultValue="proposal">
      <Tabs.List>
        <Tabs.Trigger value="proposal" className="cursor-pointer">Create Proposal</Tabs.Trigger>
        <Tabs.Trigger value="dao" className="cursor-pointer">Create DAO</Tabs.Trigger>
        <Tabs.Trigger value="verify" className="cursor-pointer">Get a DAO Verified</Tabs.Trigger>
      </Tabs.List>
