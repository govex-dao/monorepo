        ...
        <Grid columns={{ initial: "1", lg: "3" }} gap="6">
          ...
          <Box className="col-span-1 w-full">
            <Card className="p-4 shadow-xl rounded-xl backdrop-blur-sm h-full w-full">
              <Heading size="4" className="text-blue-400 flex items-center mb-4">
                <Box className="w-1.5 h-6 bg-blue-500 mr-3 rounded-full"></Box>
                Research Papers
              </Heading>
              
              <Link href="https://github.com/govex-dao/monorepo/blob/main/research/twap/TWAP-paper.pdf" target="_blank" className="block hover:bg-gray-800/30 rounded-lg transition-colors p-2 w-full">
