  ...
  const tabs = [
    {
      ...
      component: () => (
        ...
        An entity with millisecond latency root access.  
        Govex DAOs only execute instructions that the markets predict will increase its price. 
        This means that members of Govex DAOs are better protected from mismanagement than members of legacy organizations that rely on voting.  
        </Text>
        <Text size="5" weight="bold" className="mb-4 text-gray-400">
          How to Get Started:
        </Text>
        ...
        <li>3) Create a proposal for the DAO, e.g., 'Rent an office in the UAE for the DAO'.</li>
        <li>4) Trade the existing proposal.</li>
        <li>5) Wait for the trading period to finish.</li>
        <li>6) The DAO will execute the instructions (currently Govex DAOs can only advise not execute).</li>
        </Text>
      </Box>
      ),
    },
    ...
    },
    {
      ...
      component: () => (
        <Box className="p-4">
          ...
          >
            <img src="/images/x-logo.png" alt="X logo" className="w-5 h-5 mr-1" />
