...
const ProposalDetails: React.FC<ProposalDetailsProps> = ({ proposal, outcomeMessages }) => {
  return (
    <div className="rounded-lg shadow-lg">
        <div className="px-8 pb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-400">
            <div className="space-y-4">
              ...
              />
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-200">
                      {proposal?.proposal_id.slice(0, 6)}...{proposal?.proposal_id.slice(-4)}
                    </span>
                    <button
                      onClick={() => {
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span>DAO ID</span>
                      <div className="flex items-center space-x-2">
                    <span className="font-medium text-gray-200">
                      {proposal.dao_id.slice(0, 6)}...{proposal.dao_id.slice(-4)}
                    </span>
                    <button
                      onClick={() => {
                  ...
                  <div className="space-y-3">
                   <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-200">{proposal.outcome_count}</span>
                  </div>
                </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-sm uppercase mb-2 text-gray-300">State History</h3>
                <div className="space-y-2 ">
                  {proposal.state_history?.map((history: StateHistory, index: number) => (
                    <div 
                  ...
                  {(!proposal.state_history || proposal.state_history.length === 0) && (
              ...
              {outcomeMessages.length > 0 && (
                <div>
                  <h3 className="text-sm uppercase mb-2 text-gray-300">Outcomes</h3>
