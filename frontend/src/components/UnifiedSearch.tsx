              ...
              {isLoading ? (
                ...
                <div>
                      ...
                      {searchResults.data.daos.map((dao: DaoResult) => (
                        ...
                        >
                          <div className="flex items-center gap-2">
                            <span className="text-sm text-blue-400 whitespace-nowrap">DAO:</span>
                            <img
                  ...
                  {searchResults.data.proposals?.length > 0 && (
                    <div>
                      {searchResults.data.proposals.map((proposal: ProposalResult) => (
                        <div
                          key={proposal.id}
                        ...
                        <div className="flex flex-col gap-1">
                          <div className="flex items-center gap-2">
                            <span className="text-sm text-green-400 whitespace-nowrap flex-shrink-0">PROPOSAL:</span>
                            <img
                              src={proposal.dao.dao_icon || '/placeholder-dao.png'}
                              alt=""
                              className="w-5 h-5 rounded-full object-cover flex-shrink-0"
                              onError={(e) => {
                                e.currentTarget.src = '/placeholder-dao.png';
