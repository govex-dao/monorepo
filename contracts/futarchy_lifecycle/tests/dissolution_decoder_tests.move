...
module futarchy_lifecycle::dissolution_decoder_tests {
    ...
    fun test_decode_initiate_dissolution_action_prorata() {
        ...
        ts::next_tx(&mut scenario, ADMIN);
        {
            ...
            let decoder = schema::borrow_decoder<dissolution_decoder::InitiateDissolutionActionDecoder>(&registry);
    ...
    fun test_decode_batch_distribute_action() {
        ...
        ts::next_tx(&mut scenario, ADMIN);
        {
            ...
            let action_data = bcs::to_bytes(&action);
            let decoder = schema::borrow_decoder<dissolution_decoder::BatchDistributeActionDecoder>(&registry);
            ...
            assert_eq(*schema::field_value(assets_field), string::utf8(b"[0x2::sui::SUI, 0x2::usdc::USDC]"));
        };
    ...
    fun test_decode_finalize_dissolution_action() {
        ...
        ts::next_tx(&mut scenario, ADMIN);
        {
            ...
            let action_data = bcs::to_bytes(&action);
            let decoder = schema::borrow_decoder<dissolution_decoder::FinalizeDissolutionActionDecoder>(&registry);
    ...
    fun test_decode_cancel_dissolution_action() {
        ...
        ts::next_tx(&mut scenario, ADMIN);
        {
            ...
            let action_data = bcs::to_bytes(&action);
            let decoder = schema::borrow_decoder<dissolution_decoder::CancelDissolutionActionDecoder>(&registry);
    ...
    fun test_decode_calculate_pro_rata_shares_action() {
        ...
        ts::next_tx(&mut scenario, ADMIN);
        {
            ...
            let action_data = bcs::to_bytes(&action);
            let decoder = schema::borrow_decoder<dissolution_decoder::CalculateProRataSharesActionDecoder>(&registry);
            let fields = dissolution_decoder::decode_calculate_pro_rata_shares_action(decoder, action_data);
    ...
    fun test_decode_cancel_all_streams_action_return() {
        ...
        ts::next_tx(&mut scenario, ADMIN);
        {
            ...
            let action_data = bcs::to_bytes(&action);
            let decoder = schema::borrow_decoder<dissolution_decoder::CancelAllStreamsActionDecoder>(&registry);
    ...
    fun test_decode_withdraw_amm_liquidity_action() {
        ...
        ts::next_tx(&mut scenario, ADMIN);
        {
            ...
            let action_data = bcs::to_bytes(&action);
            let decoder = schema::borrow_decoder<dissolution_decoder::WithdrawAmmLiquidityActionDecoder>(&registry);
            let fields = dissolution_decoder::decode_withdraw_amm_liquidity_action<TEST_ASSET, TEST_STABLE>(
                decoder,
                action_data
            );
    ...
    fun test_decode_distribute_assets_action() {
        ...
        ts::next_tx(&mut scenario, ADMIN);
        {
            ...
            let action_data = bcs::to_bytes(&action);
            let decoder = schema::borrow_decoder<dissolution_decoder::DistributeAssetsActionDecoder>(&registry);
            let fields = dissolution_decoder::decode_distribute_assets_action<TEST_COIN>(decoder, action_data);
    ...
    fun test_register_all_decoders() {
        ...
        ts::next_tx(&mut scenario, ADMIN);
        {
            ...
            let _initiate = schema::borrow_decoder<dissolution_decoder::InitiateDissolutionActionDecoder>(&registry);
            let _batch = schema::borrow_decoder<dissolution_decoder::BatchDistributeActionDecoder>(&registry);
            let _finalize = schema::borrow_decoder<dissolution_decoder::FinalizeDissolutionActionDecoder>(&registry);
            let _cancel = schema::borrow_decoder<dissolution_decoder::CancelDissolutionActionDecoder>(&registry);
            let _prorata = schema::borrow_decoder<dissolution_decoder::CalculateProRataSharesActionDecoder>(&registry);
            let _streams = schema::borrow_decoder<dissolution_decoder::CancelAllStreamsActionDecoder>(&registry);
            let _amm = schema::borrow_decoder<dissolution_decoder::WithdrawAmmLiquidityActionDecoder>(&registry);
            let _distribute = schema::borrow_decoder<dissolution_decoder::DistributeAssetsActionDecoder>(&registry);
        };
