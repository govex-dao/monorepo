...
fun test_deps_new_latest_extensions() {
    ...
    let deps = deps::new_latest_extensions(&extensions, vector[b"AccountProtocol".to_string(), b"AccountConfig".to_string(), b"AccountActions".to_string()]);
    let dep = deps.get_by_name(b"AccountProtocol".to_string());
...
fun test_deps_add_unverified_allowed() {
    ...
    let deps = deps::new(&extensions, true, vector[b"AccountProtocol".to_string(), b"AccountConfig".to_string(), b"Other".to_string()], vector[@account_protocol, @0x1, @0x999], vector[1, 1, 1]);
...
fun test_error_deps_not_same_length() {
    ...
    let _deps = deps::new(&extensions, false, vector[b"AccountProtocol".to_string()], vector[@account_protocol, @0x1], vector[1, 1]);
...
fun test_error_deps_not_same_length_bis() {
    ...
    let _deps = deps::new(&extensions, false, vector[b"AccountProtocol".to_string()], vector[@account_protocol], vector[1, 1]);
...
fun test_error_deps_missing_account_protocol() {
    ...
    let _deps = deps::new(&extensions, false, vector[b"Other".to_string()], vector[@account_protocol], vector[1]);
...
fun test_error_deps_missing_account_protocol_first_element() {
    ...
    let _deps = deps::new(&extensions, false, vector[b"AccountConfig".to_string(), b"AccountProtocol".to_string()], vector[@0x1, @account_protocol], vector[1, 1]);
...
fun test_error_deps_missing_account_config_second_element() {
    ...
    let _deps = deps::new(&extensions, false, vector[b"AccountProtocol".to_string(), b"AccountActions".to_string()], vector[@account_protocol, @0x2], vector[1, 1]);
...
fun test_error_deps_add_not_extension_unverified_not_allowed() {
    ...
    let _deps = deps::new(&extensions, false, vector[b"AccountProtocol".to_string(), b"AccountConfig".to_string(), b"Other".to_string()], vector[@account_protocol, @0x1, @0x999], vector[1, 1, 1]);
...
fun test_error_deps_add_name_already_exists() {
    ...
    let _deps = deps::new(&extensions, false, vector[b"AccountProtocol".to_string(), b"AccountConfig".to_string(), b"AccountProtocol".to_string()], vector[@account_protocol, @0x1, @0x2], vector[1, 1, 1]);
...
fun test_error_deps_add_addr_already_exists() {
    ...
    let _deps = deps::new(&extensions, false, vector[b"AccountProtocol".to_string(), b"AccountConfig".to_string(), b"AccountActions".to_string()], vector[@account_protocol, @0x1, @0x1], vector[1, 1, 1]);
...
fun test_error_new_latest_misses_account_protocol() {
    ...
    let _deps = deps::new_latest_extensions(&extensions, vector[b"AccountConfig".to_string(), b"AccountActions".to_string()]);
...
fun test_error_new_inner_not_same_length() {
    ...
    let _deps = deps::new_inner(&extensions, &deps, vector[b"AccountProtocol".to_string()], vector[@account_protocol, @0x1], vector[1, 1]);
...
fun test_error_new_inner_not_same_length_bis() {
    ...
    let deps = deps::new_for_testing();
    let _deps = deps::new_inner(&extensions, &deps, vector[b"AccountProtocol".to_string()], vector[@account_protocol], vector[1, 1]);
...
fun test_error_new_inner_missing_account_protocol() {
    ...
    let deps = deps::new_for_testing();
    let _deps = deps::new_inner(&extensions, &deps, vector[b"Other".to_string()], vector[@account_protocol], vector[1]);
...
fun test_error_new_inner_missing_account_protocol_first_element() {
    ...
    let deps = deps::new_for_testing();
    let _deps = deps::new_inner(&extensions, &deps, vector[b"AccountConfig".to_string(), b"AccountProtocol".to_string()], vector[@0x1, @account_protocol], vector[1, 1]);
...
fun test_error_new_inner_missing_account_config() {
    ...
    let deps = deps::new_for_testing();
    let _deps = deps::new_inner(&extensions, &deps, vector[b"AccountProtocol".to_string()], vector[@account_protocol], vector[1]);
...
fun test_error_new_inner_add_not_extension_unverified_not_allowed() {
    ...
    let deps = deps::new(&extensions, false, vector[b"AccountProtocol".to_string(), b"AccountConfig".to_string()], vector[@account_protocol, @0x1], vector[1, 1]);
    let _deps = deps::new_inner(&extensions, &deps, vector[b"AccountProtocol".to_string(), b"AccountConfig".to_string(), b"Other".to_string()], vector[@account_protocol, @0x1, @0x999], vector[1, 1, 1]);
...
fun test_error_new_inner_add_name_already_exists() {
    ...
    let deps = deps::new_for_testing();
    let _deps = deps::new_inner(&extensions, &deps, vector[b"AccountProtocol".to_string(), b"AccountConfig".to_string(), b"AccountProtocol".to_string()], vector[@account_protocol, @0x1, @0x2], vector[1, 1, 1]);
