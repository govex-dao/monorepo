...
#[test_only]
module futarchy_payments::dividend_actions_tests {
    use std::string;
    ...
    fun test_do_create_dividend_basic() {
        ...
        intents::add_action(&mut builder, std::type_name::get<dividend_actions::CreateDividendAction<SUI>>(), action_data);
