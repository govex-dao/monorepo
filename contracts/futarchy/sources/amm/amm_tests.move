...
module futarchy::additional_amm_tests {
   ...
   #[test]
    ...
    fun test_swap_round_trip() {
        ...
        debug::print(&(if (final_asset > initial_asset) { final_asset - initial_asset } else { initial_asset - final_asset }));
        debug::print(&b"Stable reserve change:");
        debug::print(&(if (final_stable > initial_stable) { final_stable - initial_stable } else { initial_stable - final_stable }));
