...
module futarchy::dao_additional_tests {
    ...
    // Test coins
    public struct ASSET has drop, copy {}
    public struct STABLE has drop, copy {}
    public struct WRONG_ASSET has drop, copy {}
    public struct WRONG_STABLE has drop, copy {}
    ...
    fun test_create_proposal_with_title_too_long() {
        ...
        test_scenario::next_tx(&mut scenario, admin);
        {
            ...
            let long_title_bytes = b"";
    ...
    fun test_create_proposal_with_wrong_asset_type() {
        ...
        test_scenario::next_tx(&mut scenario, admin);
        {
            ...
            let wrong_asset_coin = coin::mint_for_testing<WRONG_ASSET>(2000, test_scenario::ctx(&mut scenario));
    ...
    fun test_create_proposal_with_wrong_stable_type() {
        ...
        test_scenario::next_tx(&mut scenario, admin);
        {
            ...
            let wrong_stable_coin = coin::mint_for_testing<WRONG_STABLE>(2000, test_scenario::ctx(&mut scenario));
    ...
    fun test_create_proposal_when_disabled() {
        ...
        test_scenario::next_tx(&mut scenario, admin);
        {
            ...
            let mut fee_manager = test_scenario::take_shared<FeeManager>(&scenario);
            let (asset_coin, stable_coin) = mint_test_coins(2000, test_scenario::ctx(&mut scenario));
            let payment = coin::mint_for_testing(fee::get_verification_fee(&fee_manager), test_scenario::ctx(&mut scenario));
    ...
    fun test_sign_result_nonexistent_proposal() {
        ...
        {
            let mut dao = test_scenario::take_shared<DAO>(&scenario);
            let mut escrow = test_scenario::take_shared<coin_escrow::TokenEscrow<ASSET, STABLE>>(&scenario);
