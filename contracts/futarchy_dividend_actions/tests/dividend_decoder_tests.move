...
#[test_only]
module futarchy_dividend_actions::dividend_decoder_tests;

use account_protocol::schema;
use futarchy_dividend_actions::dividend_actions;
use futarchy_dividend_actions::dividend_decoder;
use std::string;
use sui::bcs;
use sui::object;
...
fun test_decode_create_dividend_action() {
    ...
    assert!(
        *schema::field_value(field1) == string::utf8(b"Pre-built DividendTree object. Query tree for recipient details."),
        4,
    );
