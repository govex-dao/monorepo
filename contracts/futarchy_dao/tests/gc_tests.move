...
use account_protocol::intents::{Self, Intent, Expired};
...
use futarchy_markets::spot_token::SPOT;
...
fun test_cleanup_config_actions() {
    ...
    // Add config action
    config_actions::new_config_update(
        &mut intent,
...
fun test_sweep_multiple_intents() {
    ...
    while (i < 5) {
        ...
        // Add a memo action
        memo_actions::new_memo(&mut intent, string::utf8(b"Test memo"), TestWitness {});
...
fun test_recurring_intent_not_deleted() {
    ...
    // Add a memo action
    memo_actions::new_memo(&mut intent, string::utf8(b"Recurring memo"), TestWitness {});
...
fun test_cleanup_entry_functions() {
    ...
    // Add action
    memo_actions::new_memo(&mut intent, string::utf8(b"Entry test"), TestWitness {});
