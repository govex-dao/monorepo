...
public fun finalize_swap_session<AssetType, StableType>(
    ...
    let escrow_market_id = futarchy_markets::market_state::market_id(market_state);
...
public fun swap_balance_asset_to_stable<AssetType, StableType>(
    ...
    futarchy_markets::market_state::assert_trading_active(market_state);
    ...
    let market_outcome_count = futarchy_markets::market_state::outcome_count(market_state);
    ...
    let pool = futarchy_markets::market_state::get_pool_mut_by_outcome(market_state, outcome_idx);
