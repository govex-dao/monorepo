import { depositAndCreateTokens } from '../escrowed-tokens-utils';
...
const getDepositAndCreateTokensParams = () => {
    ...
    return {
        ...
        coinId: mint1Results.coinObjectId,
        amount: 100,
        outcomeIdx: 0,
...
const performaDepositAndCreateTokens = async () => {
    try {
        const params = getDepositAndCreateTokensParams();
        console.log('Creating deposit and coin:', params);
        
        await depositAndCreateTokens(params);
...
// Execute
performaDepositAndCreateTokens();